...
def kit2_screen(rows,title,index = 0):
    ...
    while(True):
        if keyboard.is_pressed('left'):
            return -1
        elif keyboard.is_pressed('right') or keyboard.is_pressed('a'):
            return index
...
def set9_screen():
    ...
    sleep(0.5)
    while(True):
        if keyboard.is_pressed('left') or keyboard.is_pressed('right') or keyboard.is_pressed('up') or keyboard.is_pressed('down') or keyboard.is_pressed('a'):
            print("event")
